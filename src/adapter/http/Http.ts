...
export interface IFilms {
    getFilms(dataMovieRequest: DataMovieRequest) : Promise<MoviesResponse | HttpError>;
}
...
export abstract class Http implements IFilms {
    ...
    abstract getFilms(dataMovieRequest: DataMovieRequest) : Promise<MoviesResponse | HttpError> ;
}